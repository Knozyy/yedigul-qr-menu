...
export const ITEMS = [
  {
    id: 'fava', cat: 'cold', thumb: 'FAVA', price: 240, diet: ['gf', 'veg'], popular: true,
  ...
  {
    id: 'ahtapot', cat: 'cold', thumb: 'OCTOPUS', price: 560, diet: ['gf'],
  ...
  {
    id: 'levrekmarin', cat: 'cold', thumb: 'CURED', price: 480, diet: ['gf'], chef: true,
  ...
  {
    id: 'kalamar', cat: 'hot', thumb: 'CALAMARI', price: 420, diet: [], popular: true,
  ...
  {
    id: 'karides', cat: 'hot', thumb: 'SHRIMP', price: 590, diet: ['gf'], chef: true,
  ...
  {
    id: 'midye', cat: 'hot', thumb: 'MUSSELS', price: 300, diet: [],
  ...
  {
    id: 'levrek', cat: 'fish', thumb: 'SEABASS', price: null, diet: ['gf'], popular: true,
  ...
  {
    id: 'lufer', cat: 'fish', thumb: 'BLUEFISH', price: null, diet: ['gf'],
  ...
  {
    id: 'cipura', cat: 'fish', thumb: 'BREAM', price: 640, diet: ['gf'], popular: true,
  ...
  {
    id: 'kalkan', cat: 'fish', thumb: 'TURBOT', price: null, diet: ['gf'],
  ...
  {
    id: 'dil', cat: 'fish', thumb: 'SOLE', price: 820, diet: ['gf'], chef: true,
  ...
  {
    id: 'tuzdalevrek', cat: 'special', thumb: 'SALT BAKE', price: null, diet: ['gf'], chef: true,
  ...
  {
    id: 'guvec', cat: 'special', thumb: 'SEAFOOD', price: 980, diet: ['gf'], chef: true, popular: true,
  ...
  {
    id: 'mevsim', cat: 'salad', thumb: 'GREENS', price: 190, diet: ['gf', 'veg'],
  ...
  {
    id: 'roka', cat: 'salad', thumb: 'ROCKET', price: 230, diet: ['gf', 'veg'],
  ...
  {
    id: 'ayva', cat: 'dessert', thumb: 'QUINCE', price: 190, diet: ['gf', 'veg'],
  ...
  {
    id: 'kunefe', cat: 'dessert', thumb: 'KUNEFE', price: 240, diet: ['veg'], popular: true,
  ...
  {
    id: 'raki', cat: 'drink', thumb: 'RAKI', price: 480, diet: ['gf', 'veg'], popular: true,
  ...
  {
    id: 'cay', cat: 'drink', thumb: 'TEA', price: 60, diet: ['gf', 'veg'],
  ...
  {
    id: 'ayran', cat: 'drink', thumb: 'AYRAN', price: 80, diet: ['gf', 'veg'],
...
export const UI = {
  tr: {
    tagline: 'Boğaz Balık Restoranı', tableWord: 'Masa', search: 'Menüde ara…', gf: 'Glütensiz', veg: 'Vejetaryen',
    market: 'Piyasa Fiyatı', ingredients: 'İçindekiler', allergens: 'Alerjenler',
  ...
  en: {
    tagline: 'Bosphorus Fish Restaurant', tableWord: 'Table', search: 'Search the menu…', gf: 'Gluten-Free', veg: 'Vegetarian',
    market: 'Market Price', ingredients: 'Ingredients', allergens: 'Allergens',
