...
<% @ Language = VBScript CodePage=1254 %>
 <title>Yedig�l Restaurant Subscribe</title>
 <style type="text/css">
body {
...
<center><font face="verdana" size="+1" color="#000000"><b>Email Adresi Girmemi�siniz.L�tfen Giriniz.</b></font></center>
<%response.End
end if%>
...
<center><font face="verdana" size="+1" color="#000000"><b>Ge�erli Bir Email Adresi Giriniz.</b></font></center>
<%response.End
end if%>
<% if request.form("email")="" then
%>
...
<center><font face="verdana" size="+1" color="#000000"><b>Email Girmemi�siniz.L�tfen Giriniz.</b></font></center>
<%response.End
end if%>
...
if err Then
		' SMTP hata detayını istemciye sızdırma (sunucu adı/port ifşası)
...
<center><font face="verdana" size="+1" color="#000000"><b>Mail Adresiniz Kaydedilmi�tir.�ndirim, Kampanya ve �zel Ko�ullar Olduk�a Bilgilendirileceksiniz.</b></font></center>
<script language="JavaScript" type="text/javascript">
 <!--
window.opener = self;
 window.close();
