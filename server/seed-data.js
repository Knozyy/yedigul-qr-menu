...
export const ITEMS = [
  // ===================== BALIK =====================
  {
    id: 'levrek', cat: 'fish', thumb: 'SEABASS', price: 650, portion: '350 gr', kcal: 320, diet: ['gf'], popular: true,
  ...
  {
    id: 'cipura', cat: 'fish', thumb: 'BREAM', price: 625, portion: '350 gr', kcal: 300, diet: ['gf'], popular: true,
  ...
  {
    id: 'lufer', cat: 'fish', thumb: 'BLUEFISH', price: 1250, portion: '350 gr', kcal: 380, diet: ['gf'],
  ...
  {
    id: 'cinekop', cat: 'fish', thumb: 'CHINEKOP', price: 1000, portion: '300 gr', kcal: 320, diet: ['gf'],
  ...
  {
    id: 'mezgit', cat: 'fish', thumb: 'WHITING', price: 550, portion: '350 gr', kcal: 240, diet: ['gf'],
  ...
  {
    id: 'barbunya', cat: 'fish', thumb: 'RED MULLET', price: 1000, portion: '350 gr', kcal: 300, diet: ['gf'],
  ...
  {
    id: 'tekir', cat: 'fish', thumb: 'GOATFISH', price: 850, portion: '300 gr', kcal: 290, diet: ['gf'],
  ...
  {
    id: 'istavrit', cat: 'fish', thumb: 'MACKEREL', price: 550, portion: '300 gr', kcal: 280, diet: ['gf'],
  ...
  {
    id: 'hamsi', cat: 'fish', thumb: 'ANCHOVY', price: 550, portion: '300 gr', kcal: 300, diet: ['gf'],
  ...
  {
    id: 'palamut', cat: 'fish', thumb: 'BONITO', price: null, portion: '300 gr', kcal: 350, diet: ['gf'],
  ...
  {
    id: 'kalkan', cat: 'fish', thumb: 'TURBOT', price: null, portion: '250 gr', kcal: 260, diet: ['gf'],
  ...
  {
    id: 'iskorpit', cat: 'fish', thumb: 'SCORPIONFISH', price: 750, portion: '300 gr', kcal: 340, diet: ['gf'],
  ...
  {
    id: 'dilsis', cat: 'fish', thumb: 'FLUKE SIS', price: 550, portion: '300 gr', kcal: 300, diet: ['gf'],
  ...
  {
    id: 'kilicsis', cat: 'fish', thumb: 'SWORDFISH', price: 700, portion: '350 gr', kcal: 330, diet: ['gf'],
  ...
  {
    id: 'fenersis', cat: 'fish', thumb: 'MONKFISH', price: 600, portion: '300 gr', kcal: 320, diet: ['gf'],
  ...
  {
    id: 'tuzdalevrek', cat: 'fish', thumb: 'SALT BAKE', price: null, portion: null, kcal: 400, diet: ['gf'], chef: true,
  ...
  {
    id: 'dil', cat: 'fish', thumb: 'SOLE', price: 820, portion: null, kcal: 350, diet: ['gf'], chef: true,
  ...
  // ===================== ARA SICAKLAR =====================
  {
    id: 'baliksorbasi', cat: 'hot', thumb: 'FISH SOUP', price: 350, portion: '250 gr', kcal: 180, diet: ['gf'],
  ...
  {
    id: 'jumbokarides', cat: 'hot', thumb: 'JUMBO SHRIMP', price: 600, portion: '200 gr', kcal: 260, diet: ['gf'], popular: true,
  ...
  {
    id: 'karides', cat: 'hot', thumb: 'SHRIMP', price: 700, portion: '200 gr', kcal: 380, diet: ['gf'], chef: true,
  ...
  {
    id: 'tereyagkarides', cat: 'hot', thumb: 'BUTTER SHRIMP', price: 700, portion: '200 gr', kcal: 420, diet: ['gf'],
  ...
  {
    id: 'guvec', cat: 'hot', thumb: 'SEAFOOD', price: 700, portion: '200 gr', kcal: 460, diet: ['gf'], chef: true, popular: true,
  ...
  {
    id: 'kalamar', cat: 'hot', thumb: 'CALAMARI', price: 700, portion: '200 gr', kcal: 450, diet: [], popular: true,
  ...
  {
    id: 'midyetava', cat: 'hot', thumb: 'FRIED MUSSEL', price: 375, portion: null, kcal: 350, diet: [],
  ...
  {
    id: 'midyeizgara', cat: 'hot', thumb: 'GRILLED MUSSEL', price: 425, portion: null, kcal: 220, diet: ['gf'],
  ...
  {
    id: 'sigaraboregi', cat: 'hot', thumb: 'CHEESE ROLLS', price: 300, portion: null, kcal: 300, diet: ['veg'],
  ...
  {
    id: 'balikboregi', cat: 'hot', thumb: 'FISH ROLLS', price: 400, portion: null, kcal: 320, diet: [],
  ...
  {
    id: 'balikkoftesi', cat: 'hot', thumb: 'FISH CAKE', price: 550, portion: '200 gr', kcal: 330, diet: [],
  ...
  {
    id: 'balikkokorec', cat: 'hot', thumb: 'FISH KOKOREC', price: 700, portion: '200 gr', kcal: 380, diet: [],
  ...
  {
    id: 'patatestava', cat: 'hot', thumb: 'FRIES', price: 300, portion: '200 gr', kcal: 350, diet: ['gf', 'veg'],
  ...
  {
    id: 'patlicansoslu', cat: 'hot', thumb: 'EGGPLANT', price: 300, portion: null, kcal: 220, diet: ['gf', 'veg'],
  ...
  // ===================== SOĞUK MEZELER =====================
  {
    id: 'fava', cat: 'cold', thumb: 'FAVA', price: 300, portion: null, kcal: 180, diet: ['gf', 'veg'], popular: true,
  ...
  {
    id: 'haydari', cat: 'cold', thumb: 'HAYDARI', price: 300, portion: null, kcal: 160, diet: ['gf', 'veg'],
  ...
  {
    id: 'aciliezme', cat: 'cold', thumb: 'SPICY EZME', price: 300, portion: null, kcal: 120, diet: ['gf', 'veg'],
  ...
  {
    id: 'patlicansalatasi', cat: 'cold', thumb: 'EGGPLANT SALAD', price: 300, portion: null, kcal: 180, diet: ['gf', 'veg'],
  ...
  {
    id: 'semizotu', cat: 'cold', thumb: 'PURSLANE', price: 300, portion: null, kcal: 110, diet: ['gf', 'veg'],
  ...
  {
    id: 'denizborulcesi', cat: 'cold', thumb: 'SAMPHIRE', price: 300, portion: null, kcal: 90, diet: ['gf', 'veg'],
  ...
  {
    id: 'pazikavurma', cat: 'cold', thumb: 'CHARD', price: 300, portion: null, kcal: 130, diet: ['gf', 'veg'],
  ...
  {
    id: 'pancar', cat: 'cold', thumb: 'BEET', price: 300, portion: null, kcal: 120, diet: ['gf', 'veg'],
  ...
  {
    id: 'pilaki', cat: 'cold', thumb: 'PILAKI', price: 300, portion: null, kcal: 220, diet: ['gf', 'veg'],
  ...
  {
    id: 'kisir', cat: 'cold', thumb: 'BULGUR', price: 300, portion: null, kcal: 200, diet: ['veg'],
  ...
  {
    id: 'beyazpeynir', cat: 'cold', thumb: 'WHITE CHEESE', price: 150, portion: null, kcal: 250, diet: ['gf', 'veg'],
  ...
  {
    id: 'levrekmarin', cat: 'cold', thumb: 'CURED', price: 475, portion: null, kcal: 180, diet: ['gf'], chef: true,
  ...
  {
    id: 'lakerda', cat: 'cold', thumb: 'LAKERDA', price: 500, portion: null, kcal: 280, diet: ['gf'],
  ...
  {
    id: 'ciroz', cat: 'cold', thumb: 'DRIED FISH', price: 450, portion: null, kcal: 250, diet: ['gf'],
  ...
  {
    id: 'karidessogus', cat: 'cold', thumb: 'SHRIMP COLD', price: 575, portion: null, kcal: 200, diet: ['gf'],
  ...
  {
    id: 'ahtapot', cat: 'cold', thumb: 'OCTOPUS', price: 650, portion: null, kcal: 220, diet: ['gf'],
  ...
  {
    id: 'midye', cat: 'cold', thumb: 'STUFFED MUSSEL', price: 350, portion: null, kcal: 280, diet: [],
  ...
  // ===================== SALATALAR =====================
  {
    id: 'cobansalata', cat: 'salad', thumb: 'SHEPHERD', price: 180, portion: null, kcal: 120, diet: ['gf', 'veg'],
  ...
  {
    id: 'mevsim', cat: 'salad', thumb: 'GREENS', price: 180, portion: null, kcal: 120, diet: ['gf', 'veg'],
  ...
  {
    id: 'roka', cat: 'salad', thumb: 'ROCKET', price: 180, portion: null, kcal: 150, diet: ['gf', 'veg'],
  ...
  // ===================== ET & TAVUK =====================
  {
    id: 'etsis', cat: 'meat', thumb: 'MEAT SKEWER', price: 950, portion: '200 gr', kcal: 450, diet: ['gf'],
  ...
  {
    id: 'kofte', cat: 'meat', thumb: 'MEATBALL', price: 600, portion: '250 gr', kcal: 420, diet: [],
  ...
  {
    id: 'tavukizgara', cat: 'meat', thumb: 'CHICKEN', price: 550, portion: '250 gr', kcal: 380, diet: ['gf'],
  ...
  // ===================== TATLILAR =====================
  {
    id: 'baklava', cat: 'dessert', thumb: 'BAKLAVA', price: 400, portion: null, kcal: 430, diet: ['veg'],
  ...
  {
    id: 'kunefe', cat: 'dessert', thumb: 'KUNEFE', price: 240, portion: null, kcal: 450, diet: ['veg'], popular: true,
  ...
  {
    id: 'kadayif', cat: 'dessert', thumb: 'KADAYIF', price: 350, portion: null, kcal: 420, diet: ['veg'],
  ...
  {
    id: 'kabaktatlisi', cat: 'dessert', thumb: 'PUMPKIN', price: 350, portion: null, kcal: 300, diet: ['gf', 'veg'],
  ...
  {
    id: 'ayva', cat: 'dessert', thumb: 'QUINCE', price: 350, portion: null, kcal: 350, diet: ['gf', 'veg'],
  ...
  {
    id: 'helva', cat: 'dessert', thumb: 'HALVA', price: 350, portion: null, kcal: 400, diet: ['veg'],
  ...
  {
    id: 'cikolatasufle', cat: 'dessert', thumb: 'SOUFFLE', price: 350, portion: null, kcal: 480, diet: ['veg'],
  ...
  {
    id: 'krep', cat: 'dessert', thumb: 'PANCAKE', price: 550, portion: null, kcal: 420, diet: ['veg'],
  ...
  {
    id: 'mevsimmeyve', cat: 'dessert', thumb: 'FRUITS', price: 400, portion: null, kcal: 150, diet: ['gf', 'veg'],
  ...
  {
    id: 'dondurma', cat: 'dessert', thumb: 'ICE CREAM', price: 450, portion: null, kcal: 250, diet: ['veg'],
  ...
  // ===================== İÇECEKLER =====================
  {
    id: 'raki', cat: 'drink', thumb: 'RAKI', price: 480, portion: '35 cl', kcal: 800, diet: ['gf', 'veg'], popular: true,
  ...
  {
    id: 'cay', cat: 'drink', thumb: 'TEA', price: 60, portion: null, kcal: 2, diet: ['gf', 'veg'],
  ...
  {
    id: 'ayran', cat: 'drink', thumb: 'AYRAN', price: 80, portion: null, kcal: 110, diet: ['gf', 'veg'],
